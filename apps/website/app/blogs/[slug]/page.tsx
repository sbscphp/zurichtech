...
export default async function BlogDetailPage({ params }: BlogDetailProps) {
  ...
  return (
    <article>
      <section className="relative isolate h-[420px] overflow-hidden bg-black md:h-[682px]">
        <img
          alt=""
          src={post.image}
        ...
        <div className="absolute inset-x-0 bottom-16 flex flex-col items-center gap-6 px-6 text-center text-white md:bottom-[120px]">
          <h1 className="max-w-[968px] font-display text-[32px] leading-[1.4] font-medium md:text-[40px] lg:text-[48px]">
            {post.title}
          </h1>
          <p className="max-w-[579px] font-body text-base leading-[1.4] md:text-xl">
            {post.heroSubtitle}
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 lg:px-8">
        <div className="mx-auto flex w-full max-w-[864px] flex-col gap-6 p-0 md:p-8">
            ...
            >
              ...
              {section.listIntro || section.listItems ? (
                <div className="flex flex-col gap-3 font-body text-xl leading-[1.4] text-ink-dimmed">
                  ...
                  {section.listItems ? (
                    <ul className="flex list-disc flex-col gap-3 pl-[30px]">
