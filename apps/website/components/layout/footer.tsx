 ...
 * Copy is hardcoded ahead of the Sanity wiring that follows later.
 */
export function Footer() {
  return (
    <footer className="relative mt-[172px] bg-black">
      <div className="absolute inset-x-0 top-0 z-10 -translate-y-[328px] px-6 lg:px-20">
        <div className="mx-auto max-w-[1280px]">
          <SiteCta />
        </div>
      </div>

      <div className="mx-auto w-full max-w-[1440px] px-6 pt-[241px] pb-0 lg:px-[82px]">
                  ...
                  <li key={row.text} className="flex items-start gap-3">
                    <span className="flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-[6.4px] bg-white/32">
                      <span className="relative size-4 overflow-hidden">
                        <img alt="" src={row.icon} className="block size-full" />
                      </span>
                    </span>
                    {row.href ? (
                      <a
